					...
					<div className='about-items'>
						...
						<div className='wings-description'>
							...
							<p className='wings-description-paragraph'>
								...
								Maiores quisquam voluptatem voluptates dignissimos saepe
								incidunt vitae, culpa nostrum earum voluptatum doloremque ab
								mollitia, deleniti totam optio ipsam facere id recusandae.
							</p>
						</div>
